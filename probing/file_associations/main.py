...
class FileAssociationTracker:
    ...
    def __init__(self, project_path: Union[str, PathLike]):
        ...
        self.output_dir = join_paths(script_dir, "probing", "file_associations", "output")
        ...
        try:
            ...
            if summary_path and os.path.exists(summary_path):
                ...
                try:
                    ...
                    from probing.insights_generator.main import generate_insights
                    from probing.insights_generator.entity_analyzer import CodeEntityAnalyzer
